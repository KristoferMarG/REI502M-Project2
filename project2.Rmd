...
We decided to try 3 different ways of discretizising our numerical variables. We used equal frequency, equal intervals an k-means clustering. In our opinion it was not necessary to remove / ignore any attributes because each of the attributes was a specific medical test and therefore had some valuable information.
...
Since the data set is not very big we decided to put the minimum support threshold for the Apriori algorithm at 0.05 to prevent getting results that could be coincidental. We also decided to set the confidence factor pretty high at 0.9 since we are looking for strong rules.
